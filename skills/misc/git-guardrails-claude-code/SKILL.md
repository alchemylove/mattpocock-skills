...
description: 危険な git コマンド（push、reset --hard、clean、branch -D など）を実行前に block する Claude Code hooks をセットアップする。ユーザーが破壊的な git 操作を防ぎたい、git safety hooks を追加したい、または Claude Code で git push/reset を block したいときに使う。
---
